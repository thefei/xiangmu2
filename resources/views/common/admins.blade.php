	...
	<div id="mws-header" class="clearfix">
    	...
    	<div id="mws-logo-container">
        	...
        	<div id="mws-logo-wrap">
                ...
                <h3 style='color:white'>{{Config::get('app.webname')}}</h3>
			</div>
        </div>
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li>
                        <a href="#"><i class="icon-bag"></i>会员管理</a>
                        <ul class='closed'>
                            <li><a href="/admin/huiyuan">浏览会员</a></li>
                            
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="icon-bag"></i>轮播图管理</a>
                        <ul class='closed'>
                            <li><a href="/home/img/create">添加轮播图</a></li>
                            <li><a href="/home/img">浏览轮播图</a></li>
